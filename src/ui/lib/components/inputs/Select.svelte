...
<style lang="postcss">
	...
	select {
		@apply border-0 bg-figma-color-bg text-figma-color-text pr-4 pl-6 font-normal rounded-none leading-none outline-none ring-0 placeholder:text-figma-color-text h-[inherit] w-[inherit];
		font-size: 11px;
